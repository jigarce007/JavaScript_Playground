// Destructuring Arrays - it unpack the values from an array and assign it to variables.

const array1 = ["ahmedabad","sdney","kuala lumpur"];
//to destructre the array to variables..
const[city1,city2,city3] = array1;
console.log(city1,city2,city3)

//aray destructring Assignment.
...
const books = [
  ...
  //challenge 1 - Destructure the books array into two variables called firstBook and secondBook.
  //solution
  const[firstBook,secondBook] = books
  console.log(firstBook,secondBook)

  //challenge 2 - Destructure the books array into a variable called thirdBook. You must skip the first two books.
  //solution
